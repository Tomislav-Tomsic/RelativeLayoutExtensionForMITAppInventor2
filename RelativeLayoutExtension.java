package tomislavt.extensions.RelativeLayoutExtension;
 ...
 *
 */
@DesignerComponent(version = 2, description = "<p>Implementation of Relative layout for "
...
public class RelativeLayoutExtension extends AndroidNonvisibleComponent {
  ...
  public void AddComponent (final AndroidViewComponent component) {
   ...
   ViewGroup.MarginLayoutParams mp =  (MarginLayoutParams) component.getView().getLayoutParams();
   
   myComponentLp.leftMargin = mp.leftMargin;
   myComponentLp.rightMargin = mp.rightMargin;
   myComponentLp.topMargin = mp.topMargin;
   myComponentLp.bottomMargin = mp.bottomMargin;
   
    
    /*
     *  Placement, meaning translation 
     */
      ...
      if (getRootParent() == null) {
        androidUIHandler.postDelayed(new Runnable() {
          ...
          public void run() {
            ...
            rootLayout.addView(component.getView(),
                myComponentLp);
            /*
             * This is a silly if statment, but it seems that in
             * more complicated View hierarchies some artefact stays
             * in memory and that causes problems with additinal
             * view additions. Tomi
             */
            final ViewGroup previousRootParent = (ViewGroup) rootLayout
                .getParent();
            if (previousRootParent != null) {
              previousRootParent.removeView(rootLayout);
            }
  ...
  public void AddAndPlaceComponent (final AndroidViewComponent component,
      ...
      if (getRootParent() == null) {
        androidUIHandler.postDelayed(new Runnable() {
          ...
          public void run() {
            ...
            mySecondPlacedComponentLp = translateLP(component,
  ...
  private RelativeLayout.LayoutParams translateLP(
    ...
    myPlacedComponentLp.leftMargin = mp.leftMargin;
    myPlacedComponentLp.rightMargin = mp.rightMargin;
    myPlacedComponentLp.topMargin = mp.topMargin;
    myPlacedComponentLp.bottomMargin = mp.bottomMargin;
    ...
    case 18:
      ...
      break;
    case 19:
      myPlacedComponentLp.addRule(RelativeLayout.CENTER_VERTICAL,
          RelativeLayout.TRUE);
      break;
    case 20:
      myPlacedComponentLp.addRule(RelativeLayout.END_OF, anchor);
  ...
  @SimpleFunction(description = "Return's component's id.")
